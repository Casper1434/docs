...
Our network boasts robust security measures, including specialized DDoS protection tailored for gaming. Given the rising sophistication of attacks mimicking gaming traffic, we've fortified our defenses with dedicated filters customized for various games. These bespoke filters bolster our security framework, fortifying us against DDoS assaults aimed at online gaming platforms.

Should your desired game not be included in the aforementioned list, don't hesitate to reach out. We're receptive to implementing tailored DDoS protection solutions aligned with your game's unique needs.
...
**The following (UDP) application filters are available and can be applied on any port (range):**
